...
<link rel="stylesheet" href="css/bakery_thai.css">
      ...
      <div class="row">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ขนมไทย</li>
          </ol>
        </nav>
      </div>
            ...
            <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12 col-12">
              ...
              <a href="bakery_product.php">
                <div class="card">
                  ...
                  <div class="card-body">
                    <span class="card-text">ขนมวุ้น<span><p class="card-text" style="float: right;">45.-</p>
                  </div>
                </div>
</a>
              </div>
              <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12 col-12">
                ...
                <a href="bakery_product.php">
                  <img src="img/product1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <span class="card-text">เปียกปูน</span><p class="card-text" style="float: right;">45.-</p>
                  </div>
                </div>
</a>
              </div>
              <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12 col-12">
                ...
                <a href="bakery_product.php">
                  <img src="img/product1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <span class="card-text">ตะโก้</span><p class="card-text" style="float: right;">45.-</p>
                  </div>
                </div>
</a>
              </div>
            ...
            <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12 col-12">
              ...
              <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12 col-12">
                ...
                <a href="bakery_product.php">
                  <img src="img/product1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <span class="card-text">เค้กไข่</span><p class="card-text" style="float: right;">45.-</p>
                  </div>
                </div>
</a>
              </div>
